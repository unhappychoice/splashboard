...
pub fn tokyo_night() -> Theme {
    Theme {
        ...
        title: hex(0x7a, 0xa2, 0xf7),
        status_ok: hex(0x9e, 0xce, 0x6a),
        status_warn: hex(0xe0, 0xaf, 0x68),
        status_error: hex(0xf7, 0x76, 0x8e),
        dim: hex(0x56, 0x5f, 0x89),
        secondary: hex(0x9a, 0xa5, 0xce),
        today: hex(0xe0, 0xaf, 0x68),
        event: hex(0x7d, 0xcf, 0xff),
        series: vec![
            hex(0xf7, 0x76, 0x8e),
            hex(0x7a, 0xa2, 0xf7),
            hex(0x9e, 0xce, 0x6a),
...
pub fn nord() -> Theme {
    Theme {
        ...
        title: hex(0x88, 0xc0, 0xd0),
        status_ok: hex(0xa3, 0xbe, 0x8c),
        status_warn: hex(0xeb, 0xcb, 0x8b),
        status_error: hex(0xbf, 0x61, 0x6a),
        dim: hex(0x43, 0x4c, 0x5e),
        secondary: hex(0xe5, 0xe9, 0xf0),
        today: hex(0xeb, 0xcb, 0x8b),
        event: hex(0x8f, 0xbc, 0xbb),
        series: vec![
            hex(0x88, 0xc0, 0xd0),
            hex(0xa3, 0xbe, 0x8c),
            hex(0xeb, 0xcb, 0x8b),
...
pub fn dracula() -> Theme {
    Theme {
        ...
        border: hex(0x44, 0x47, 0x5a),
        title: hex(0xbd, 0x93, 0xf9),
        status_ok: hex(0x50, 0xfa, 0x7b),
        status_warn: hex(0xf1, 0xfa, 0x8c),
        status_error: hex(0xff, 0x55, 0x55),
        dim: hex(0x62, 0x72, 0xa4),
        secondary: hex(0xf8, 0xf8, 0xf2),
        today: hex(0xf1, 0xfa, 0x8c),
        event: hex(0x8b, 0xe9, 0xfd),
        series: vec![
            hex(0xff, 0x79, 0xc6),
            hex(0x8b, 0xe9, 0xfd),
            hex(0x50, 0xfa, 0x7b),
...
pub fn gruvbox_dark() -> Theme {
    Theme {
        ...
        border: hex(0x7c, 0x6f, 0x64),
        title: hex(0xfa, 0xbd, 0x2f),
        status_ok: hex(0xb8, 0xbb, 0x26),
        status_warn: hex(0xfa, 0xbd, 0x2f),
        status_error: hex(0xfb, 0x49, 0x34),
        dim: hex(0x66, 0x5c, 0x54),
        secondary: hex(0xa8, 0x99, 0x84),
        today: hex(0xfa, 0xbd, 0x2f),
        event: hex(0x83, 0xa5, 0x98),
        series: vec![
            hex(0xfb, 0x49, 0x34),
            hex(0x83, 0xa5, 0x98),
            hex(0xb8, 0xbb, 0x26),
...
pub fn catppuccin_mocha() -> Theme {
    Theme {
        ...
        border: hex(0x45, 0x47, 0x5a),
        title: hex(0x89, 0xb4, 0xfa),
        status_ok: hex(0xa6, 0xe3, 0xa1),
        status_warn: hex(0xf9, 0xe2, 0xaf),
        status_error: hex(0xf3, 0x8b, 0xa8),
        dim: hex(0x58, 0x5b, 0x70),
        secondary: hex(0xa6, 0xad, 0xc8),
        today: hex(0xf9, 0xe2, 0xaf),
        event: hex(0x94, 0xe2, 0xd5),
        series: vec![
            hex(0xf3, 0x8b, 0xa8),
            hex(0x89, 0xb4, 0xfa),
            hex(0xa6, 0xe3, 0xa1),
...
mod tests {
    ...
    fn every_preset_populates_all_palette_arrays() {
        ...
        for name in KNOWN {
            ...
            assert!(!t.series.is_empty(), "{name}: series is empty");
            assert!(!t.heatmap_ramp.is_empty(), "{name}: heatmap_ramp is empty");
        }
    }
}
